namespace DockerPush
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btn
            // 
            btn.Location = new Point(446, 12);
            btn.Name = "btn";
            btn.Size = new Size(196, 38);
            btn.TabIndex = 0;
            btn.Text = "Gönder";
            ...
            image_txt.Size = new Size(204, 27);
            image_txt.TabIndex = 1;
            // 
            // list_box
            // 
            list_box.FormattingEnabled = true;
            list_box.Location = new Point(12, 56);
            list_box.Name = "list_box";
            list_box.Size = new Size(630, 644);
            list_box.TabIndex = 2;
            // 
            // hub_txt
            // 
            hub_txt.Location = new Point(236, 12);
